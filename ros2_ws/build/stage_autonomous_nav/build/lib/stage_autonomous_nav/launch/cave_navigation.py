...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # one_tf_tree:=true in Stage prefixes every robot TF frame.
        DeclareLaunchArgument('odom_frame', default_value='robot_0/odom'),
        DeclareLaunchArgument('base_frame', default_value='robot_0/base_link'),
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={
                ...
                'use_sim_time': use_sim_time,
                'autostart': 'true',
                # nav2_bringup evaluates this with PythonExpression.
